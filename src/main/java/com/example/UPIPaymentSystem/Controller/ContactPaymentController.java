...
public class ContactPaymentController {
                               ...
                               Model model) 
    {
     ...
     // 1. Find sender account
        ...
        if (fromAccount.getUser().equals(toAccount.getUser()))
        {
            ...
            return "Bank/contact-payment";  // Transaction happen in Same Account
        }
        ...
        return "Bank/contact-payment-pin";
    }
                                 ...
                                 RedirectAttributes redirectAttributes)
    {
        ...
        if (auth != null && auth.isAuthenticated()) {
            ...
            // Find user by mobile
            User user = userService.findById(Usermobile).orElse(null);
            if (user == null) 
            {
	        ...
	        if (!user.getPin().equals(pin)) 
	        {
	            ...
	            return "Bank/contact-payment-pin";  // stay on PIN page
	        }
